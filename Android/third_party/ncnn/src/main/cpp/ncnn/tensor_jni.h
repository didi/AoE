...
#define NCNNJNI_METHOD2(METHOD_NAME) \
  Java_com_didi_aoe_runtime_ncnn_Tensor_##METHOD_NAME
...
NCNNJNI_METHOD2(create)(JNIEnv *env, jclass clazz, jlong interpreterHandle, jint tensorIndex, jboolean isInput);
